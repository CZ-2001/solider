...
void Init_Uart2(u32 Bound)
{
    ...
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2,ENABLE);//使能USART7时钟
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_DMA1,ENABLE);          //DMA1时钟使能 
    //GPIO引脚复用映射
    GPIO_PinAFConfig(GPIOA,GPIO_PinSource2,GPIO_AF_USART2);       //引脚复用映射  PE7 => USART7_RX
    GPIO_PinAFConfig(GPIOA,GPIO_PinSource3,GPIO_AF_USART2);      //引脚复用映射 PE8 => USART7_TX
    //GPIO结构体设置
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2 | GPIO_Pin_3;        //管脚指定  PE7  PE8
